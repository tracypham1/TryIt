                ...
                db.collection("users").document(userID).collection("drafts")
                    ...
                    .addOnSuccessListener(new OnSuccessListener<DocumentReference> () {
                        ...
                        public void onSuccess(DocumentReference documentReference) {
                            ...
                            Toast.makeText(PostRecipe.this, "Draft Saved!",
                    ...
                    .addOnFailureListener(new OnFailureListener() {
                        ...
                        public void onFailure(@NonNull Exception e) {
                            Toast.makeText(PostRecipe.this, "Error Occurred! Try again.",
                                Toast.LENGTH_SHORT).show();
                        }
                    });
        ...
        butt_addIn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(emptyCount == 0) {
                    ...
                    Toast.makeText(PostRecipe.this, "Ingredient Added",
                            Toast.LENGTH_SHORT).show();
                }
                    ...
                    db.collection("recipes")
                            ...
                            .addOnSuccessListener(new OnSuccessListener<DocumentReference> () {
                                ...
                                public void onSuccess(DocumentReference documentReference) {
                                    ...
                                    Toast.makeText(PostRecipe.this, "Recipe Posted!",
                                            Toast.LENGTH_SHORT).show();
